...
import org.wahlzeit.model.DogPhotoFactory;
...
public abstract class ModelMain extends AbstractMain {
	...
	protected void startUp(String rootDir) throws Exception {
		...
		log.config(LogBuilder.createSystemMessage().addAction("init DogPhotoFactory").toString());
		DogPhotoFactory.initialize();

		log.config(LogBuilder.createSystemMessage().addAction("load DogPhotos").toString());
		DogPhotoManager.getInstance().init();
	}
	...
	public void saveAll() throws IOException{
		...
		DogPhotoManager.getInstance().savePhotos();
	...
	protected void createUser(String userId, String nickName, String emailAddress, String photoDir) throws Exception {
		...
		DogPhotoManager photoManager = DogPhotoManager.getInstance();
